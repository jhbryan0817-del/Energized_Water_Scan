"""Export the active validated Rev-B.4 model. No screenshots of optional bodies."""
...
def run(_context: str):
 ...
 assert d.exportManager.execute(d.exportManager.createFusionArchiveExportOptions(os.path.join(BASE,'cad','Energized_Water_Scanner_RevB4.f3d')))
 ...
 assert td.exportManager.execute(td.exportManager.createSTEPExportOptions(os.path.join(BASE,'cad','Energized_Water_Scanner_RevB4.step')))
